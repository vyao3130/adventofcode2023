        ...
        if "seeds" in line: # seed line
            ...
            for place, seed in enumerate(seed_list):
                for ranges in mapping_dict:
                    ...
                    if seed_location <= seed <= max_seed_location:
                        new_loc = seed-seed_location + seed_destination
                        # solutions.append(f"found seed {seed} {new_loc} is {seed_location}-{seed}+{seed_destination} \n")
